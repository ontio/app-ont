...
The Ontology application supports the following features:

- Query public keys
- Parse, display and sign transactions of ONT, ONG and some OEP-4 tokens, including staking/unstaking.
